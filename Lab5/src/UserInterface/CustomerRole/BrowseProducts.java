...
//        
    ...
    private void initComponents() {
        ...
        jLabel4.setFont(new java.awt.Font("Vijaya", 3, 48)); // NOI18N
        ...
        add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 380, -1, -1));
    ...
    private void btnBackActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBackActionPerformed
        ...
        if(orderTable.getRowCount()>0){
            for(int i=0;i<orderTable.getRowCount();i++){
                ...
                String name=orderTable.getValueAt(i, 0).toString();
                int quantity=Integer.parseInt(orderTable.getValueAt(i, 2).toString());
                for(Supplier s: supplierDirectory.getSupplierlist()){
                    for(Product p: s.getProductCatalog().getProductcatalog()){
                        if(oi.getProduct().equals(p))
                            if(p.getProdName().equalsIgnoreCase(name)){
                                oi.getProduct().setAvail(oi.getProduct().getAvail()+quantity);
                            }
                    }
                }
            }
            ...
            JOptionPane.showMessageDialog(this, "Please check the operation once");
        }
...
// TODO add your handling code here:
    ...
    private void addtoCartButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addtoCartButton6ActionPerformed
        ...
        if (fetchQty <= 0) {
            JOptionPane.showMessageDialog(this, "quantity can not be zero");
            return;
        }
        try {
            double salesPrice = Double.parseDouble(txtSalesPrice.getText());
            if (salesPrice < selectedProduct.getPrice()) {
                JOptionPane.showMessageDialog(this, "sales price cannot be less than actual price");
                return;
            }
            ...
            //e.printStackTrace();
            JOptionPane.showMessageDialog(this, "Invalid Sales Price");
            return;
        }
...
//        
    ...
    private void btnCheckOutActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCheckOutActionPerformed
        ...
        if (order.getOrderItemList().size() > 0) {
            Order o = masterOrderCatalog.addOrder(order);//you cannot modify masterordercatalog if you want
...
//quantity should not be null or empty when click modify button
        ...
        try {
            ...
            if (newQty > (currentAvail + oldQty)) {
                JOptionPane.showMessageDialog(null, "quantity if more than availability");
                return;
            } else {
                if (newQty <= 0) {
                    JOptionPane.showMessageDialog(null, "a quanity should be greater than 0");
                    return;
                }
...
// TODO add your handling code here:
    ...
    private void btnSearchProductActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchProductActionPerformed
        try {
            ...
            // e.printStackTrace();
            JOptionPane.showMessageDialog(this, "Please enter valid Search");
        }
    ...
    private void btnRemoveOrderItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRemoveOrderItemActionPerformed
        ...
        JOptionPane.showMessageDialog(this, "Orderitem removed from the cart");
        refreshOrderTable();
        populateTable();
