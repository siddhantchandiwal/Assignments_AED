...
private MasterOrderCatalog masterOrderCatalog;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        BrowseProducts bs = new BrowseProducts(userProcessContainer, supplierDirectory,masterOrderCatalog);
        userProcessContainer.add("browse product", bs);
        CardLayout layout = (CardLayout)userProcessContainer.getLayout();
        layout.next(userProcessContainer);
        }
        else
         JOptionPane.showMessageDialog(this, "Please add atleast 1 supplier!!");
